...
#PBS -N jnarre_getrap
#PBS -o  /lfs/h2/emc/ptmp/Binbin.Zhou/narre/tmpnwprd1/narre_getrap
#PBS -e  /lfs/h2/emc/ptmp/Binbin.Zhou/narre/tmpnwprd1/narre_getrap
#PBS -q dev
#PBS -S /bin/bash
...
$HOMEnarre/jobs/JNARRE_GETRAP $cyc 
