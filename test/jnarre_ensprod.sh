...
#PBS -N jnarre_ensprod
#PBS -o  /lfs/h2/emc/ptmp/Binbin.Zhou/narre/tmpnwprd1/narre_ensprod
#PBS -e  /lfs/h2/emc/ptmp/Binbin.Zhou/narre/tmpnwprd1/narre_ensprod
#PBS -q dev
#PBS -S /bin/bash
...
$HOMEnarre/jobs/JNARRE_ENSPROD $cyc
